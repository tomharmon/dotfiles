...
cargo install bat  bindgen  bottom  broot  cargo-expand  cargo-license cargo-update  cargo-edit  cbindgen  exa  fd-find  flamegraph  git-delta git-journal  grex  hyperfine  ripgrep  sccache  tokei  xsv  zoxide wthrr bartib
